...
import ru.otus.otuskotlin.calendar.api.v2.models.EventSearchFilter
import ru.otus.otuskotlin.calendar.api.v2.models.EventUpdateObject
import ru.otus.otuskotlin.calendar.e2e.be.fixture.client.Client
import ru.otus.otuskotlin.calendar.e2e.be.test.action.v2.*

fun FunSpec.testApiV2(client: Client, prefix: String = "", debug: EventDebug = debugStubV2) {
    context("${prefix}v2") {
...
//            }
        ...
        test("Search Event ok") {
            ...
            withClue("Search Sprint 1") {
                client.searchEvent(
                    search = EventSearchFilter(searchString = "Sprint 1"),
                    debug = debug
                )
