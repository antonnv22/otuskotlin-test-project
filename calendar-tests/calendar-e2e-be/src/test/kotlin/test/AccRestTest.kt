...
import ru.otus.otuskotlin.calendar.e2e.be.docker.WiremockDockerCompose
...
import ru.otus.otuskotlin.calendar.e2e.be.docker.KtorJvmPGDockerCompose
import ru.otus.otuskotlin.calendar.e2e.be.docker.KtorLinuxPGDockerCompose
import ru.otus.otuskotlin.calendar.e2e.be.docker.SpringDockerCompose
import ru.otus.otuskotlin.calendar.e2e.be.fixture.client.RestClient
import ru.otus.otuskotlin.calendar.e2e.be.test.action.v1.toV1
import ru.otus.otuskotlin.calendar.e2e.be.test.action.v2.toV2
